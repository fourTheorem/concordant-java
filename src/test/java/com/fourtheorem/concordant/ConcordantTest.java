...
public class ConcordantTest {
  ...
  private void testSrvResolver(IResolver srvResolver) throws Exception {
  ...
  private void testSrvResolverMulti(IResolver srvResolver) throws Exception {
  ...
  private void testAResolver(IResolver aResolver) throws Exception {
  ...
  private void testAResolverMulti(IResolver aResolver) throws Exception {
